...
import { textBlock, quoteBlock } from '../../lib/notion/renderers'
  ...
  return (
    <>
      ...
      <div className={blogStyles.post}>
        ...
        {post.Date && (
          <div className={blogStyles.postDate}>Posted: {getDateStr(post.Date)}</div>
        )}
        ...
        {(post.content || []).map((block, blockIdx) => {
          ...
          switch (type) {
            ...
            case 'quote': {
              if (properties.title) {
                toRender.push(quoteBlock(properties.title, id))
              }
              break
            }
            case 'callout': {
